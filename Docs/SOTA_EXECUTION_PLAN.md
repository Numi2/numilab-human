...
- promotion of cap 8 as the runtime default on the published
  ...
  this branch has not yet been reconciled onto the native default line;
...
These gates are independent evidence predicates, not calendar phases. Every
dependency-ready lane runs concurrently; a blocked instrumentation surface does
not serialize causal mechanics, data admission, anatomy, or interface work.
