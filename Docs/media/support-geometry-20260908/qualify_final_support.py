...
for steps,dt in [(1,'0.0001'),(6,'0.0001'),(12,'0.00005'),(24,'0.000025'),(48,'0.0000125'),(60,'0.00001'),(64,'0.0001')]:
 label=f'qualified-{steps}-{dt}';cmd=list(base);cmd[4]=str(out/label);cmd[cmd.index('--muscle-step-count')+1]=str(steps);cmd[cmd.index('--muscle-step-seconds')+1]=dt
 ...
 rows.append(row);(out/'qualified.json').write_text(json.dumps(rows,indent=2)+'\n')
