...
OUT = Path('/Users/n/human-cardiac-source-valve-20260912/final-attempt-001')
...
TARGETS = [
    ...
    'numi-matter-fem-reference-check', 'numi-matter-directional-valve-check',
]
TESTS = [
    ...
    'matter.compiler.directional_valve', 'matter.metal.directional_valve',
]
...
evidence = {'schema': 'numilab-human.directional-valve-native-execution.v1',
