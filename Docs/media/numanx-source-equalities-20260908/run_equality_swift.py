...
payload = base/'input/myosim-fullbody-joint-equalities-source-compliance.nheq'
h = 14695981039346656037
for b in payload.read_bytes(): h = ((h ^ b) * 1099511628211) & ((1 << 64) - 1)
selected.update(NUMANX_JOINT_EQUALITIES=str(payload), NUMANX_JOINT_EQUALITY_FP=f'{h:016x}', MTL_DEBUG_LAYER='1', MRNX_PHYSICAL_DIAGNOSTICS='1')
...
with (base/'equality-swift-e2e.log').open('w') as output:
 ...
 try:
  ...
  returncode = 124
(base/'equality-swift-e2e-launch.json').write_text(json.dumps({
