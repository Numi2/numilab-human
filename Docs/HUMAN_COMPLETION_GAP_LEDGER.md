...
| Blood mechanics | ABI38 explicit one-owner-per-compartment registration, normalized FEM mass partition, cooked reference first/second spatial moments, dynamic-volume gravity correction, co-moving inertial transfer, production dynamic spatial-moment evaluation, and the physical-M4-Pro [time-integrated moment/closed-surface pressure-impulse audit](BLOOD_MOMENT_CLOSURE_20260913.md) now pass compiler, native Metal, package round-trip, and replay checks; pressure-gradient momentum, anatomical registration, and organ mechanics remain open | mechanical density convention, anatomical body registration and subject calibration |
