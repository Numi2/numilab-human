...
[`gap-execution/report-v62.json`](media/gap-execution-20260915/report-v62.json).
...
| Anatomical collision and contact | source-bound ten-primitive plantar ellipsoid candidate from the authored NHCNT1 witnesses and paired NHBONES1 frames; isolated native Mac mini active-set fit closes body weight and floating-root wrench with bitwise replay ([receipt](media/anatomical-support-candidate-20260915/native-static-support-receipt-v1.json)); the paired all-128-DoF force ledger reconstructs every six-source row and identifies the internal residual leaders ([ledger](media/anatomical-support-candidate-20260915/native-support-force-ledger-v1.json)) | partial | internal generalized equilibrium remains false with a 14.8179 N maximum residual and closure ratio 1.0; dynamic contact, calibrated friction/compliance, swept-motion bounds, sustained loading, standing, recovery, and walking remain open | source-bound anatomical colliders, calibrated contact/material receipts, and held-out support/contact outcomes |
