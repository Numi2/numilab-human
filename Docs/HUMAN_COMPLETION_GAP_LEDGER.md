...
[`gap-execution/report-v59.json`](media/gap-execution-20260915/report-v59.json).
...
| Anatomical collision and contact | eight source capsules and two heel ellipsoids use current-pose native/Metal support queries; initial source geometry and wrench pass; independent support impulses now pass bounded loaded weight/friction, batched replay and arena-admission checks ([receipt](HARD_SUPPORT_KKT_20260908.md)); the [foot contact registration candidate](FOOT_CONTACT_REGISTRATION_CANDIDATE_20260914.md) binds 60 exact source-local foot rows, 30 reviewed is_a members, four target foot bodies, seven-pose continuity and six active support witnesses; the [body-frame proxy candidate](FOOT_CONTACT_PROXY_CANDIDATE_20260915.md) now transforms all 30 registered source enclosures into deterministic conservative target-body bounds; the [native equilibrium audit](NATIVE_STAND_EQUILIBRIUM_AUDIT_20260914.md) retains runtime active-set ownership as unresolved | partial | BodyParts3D collider admission, collision exclusions, calibrated friction/compliance, swept-motion bounds, and whole-body anatomical contact remain open | conservative registered proxies, material receipts, deterministic replay, and held-out support/contact outcomes |
