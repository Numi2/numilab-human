...
| Blood mechanics | ABI38 explicit one-owner-per-compartment registration, normalized FEM mass partition, cooked reference first/second spatial moments, dynamic-volume gravity correction, co-moving inertial transfer, and a production dynamic spatial-moment audit now pass compiler, native Metal, package round-trip, and replay checks; pressure-driven momentum, anatomical registration, and organ mechanics remain open | mechanical density convention, anatomical body registration and subject calibration |
