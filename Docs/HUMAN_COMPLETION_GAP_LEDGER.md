...
[`gap-execution/report-v61.json`](media/gap-execution-20260915/report-v61.json).
...
| Anatomical collision and contact | source-bound ten-primitive plantar ellipsoid candidate from the authored NHCNT1 witnesses and paired NHBONES1 frames; isolated native Mac mini active-set fit closes body weight and floating-root wrench with bitwise replay ([receipt](media/anatomical-support-candidate-20260915/native-static-support-receipt-v1.json)) | partial | internal generalized equilibrium remains false; dynamic contact, calibrated friction/compliance, swept-motion bounds, sustained loading, standing, recovery, and walking remain open | source-bound anatomical colliders, calibrated contact/material receipts, and held-out support/contact outcomes |
