...
2. Turn the exact anterior-thorax composite load boundary into registered,
   calibrated costal-cartilage/aponeurosis volume with non-duplicated two-way
   reaction ownership, then intervertebral discs, named ligaments, registered
