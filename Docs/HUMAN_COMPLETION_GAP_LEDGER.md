...
| Systemic physiology | source-bound HumanPack physiology, persistent passive blood-volume/flow/species and fixed organ-reservoir exchange in the existing Matter transaction; physical M4 Pro conservation, FP64/refinement, replay/reset/rollback and prepared-proof checks pass ([receipt](ORGAN_CIRCULATION_INTEGRATION_20260912.md)) | partial | anatomical template retains 276 unresolved parameters; cardiac drive/valves, calibrated perfusion, deforming organ feedback, blood mass partition, gas/metabolism/thermal state and held-out physiology remain unqualified | sourced models and parameters, conservative multi-rate coupling, physiological observables and exact-stack replay with uncertainty |
