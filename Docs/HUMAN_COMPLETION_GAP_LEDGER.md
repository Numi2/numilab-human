...
| Blood mechanics | ABI37 explicit one-owner-per-compartment registration, normalized FEM mass partition, cooked reference first/second spatial moments, dynamic-volume gravity correction, and co-moving inertial transfer now pass compiler, native Metal, package round-trip, and replay checks; dynamic spatial moments, pressure-driven momentum, and anatomical registration remain open | mechanical density convention, anatomical body registration and subject calibration |
